...
@section('content')
            ...
            <nav class="navbar py-2 navbar-expand-lg navbar-light d-flex justify-content-between align-items-center">
                <div class="d-flex justify-content-between align-items-center">
                    <a class="navbar-brand p-0" href="#">
                        <img src="{{url('web public/assets/images/logo/asxox-header-img.gif')}}" class="main-logo" alt="">
                    </a>
        ...
        <div class="swiper mySwiper banner-slide">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{url('web public/assets/css/images/grocery.webp')}}" class="" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="{{url('web public/assets/css/images/grocery.webp')}}" class="" alt="">
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="single-cart-container">
                        ...
                        <div class="cart-product-image mx-4">
                            <img src="{{url('web public/assets/images/products/Apples.webp')}}" alt="">
                        </div>
                        <div>
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        <div class="swiper mySwiper categories-slide">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{url('web public/assets/images/categories/1.jpg')}}" class="w-100 rounded" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{url('web public/assets/images/categories/2.jpg')}}" class="w-100 rounded" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{url('web public/assets/images/categories/1.jpg')}}" class="w-100 rounded" alt="">
                                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card mb-2 mx-1">
                                ...
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                        <img src="{{url('web public/assets/images/products/Apples.webp')}}" class="" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                      <img src="{{url('web public/assets/images/products/BabySpinach.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                       <img src="{{url('web public/assets/images/products/blueberries.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                      <img src="{{url('web public/assets/images/products/BrusselsSprouts.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                       <img src="{{url('web public/assets/images/products/clementines.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                        <img src="{{url('web public/assets/images/products/Corn.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                       <img src="{{url('web public/assets/images/products/Cucumber.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                       <img src="{{url('web public/assets/images/products/Dates.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                       <img src="{{url('web public/assets/images/products/FrenchGreenBeans.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-2dot4 p-0">
                            <div class="card mb-2 mx-1">
                                <div class="single-product-card">
                                    <a href="product-detail.html" class="text-decoration-none">
                                        <img src="{{url('web public/assets/images/products/GreenBeans.webp')}}" class="" alt="">
                                    </a>
                                </div>
                                <div class="single-product-detail">
                                    <div class="mb-2 single-product-amount">
    ...
    <script src="{{url('web public/assets/vendor/jquery/dist/jquery.js')}}"></script>
    <script src='http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js'></script>
    <script src="{{url('web public/assets/vendor/bootstrap/js/bootstrap.bundle.js')}}"></script>
    <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
    <!-- extra js -->
    <script src="{{url('web public/assets/js/script.js')}}"></script>
